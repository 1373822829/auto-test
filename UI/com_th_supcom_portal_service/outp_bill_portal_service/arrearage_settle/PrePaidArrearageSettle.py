    ...
    for application_type in application_type_list:
        ...
        if diction:
            ...
            for t in list(set(executive_department_list)):
                ...
                send_value(browser, (By.XPATH, application_list_window.开始时间), '2017-6-12')
...
if __name__ == '__main__':
    ...
    test_prepaid_arrearage_settle(browser, cache)
